...
func isSuperAdmin(qq int64) bool {
	return qq == fengshengConfig.GetInt64("qq.super_admin_qq")
}

func isAdmin(qq int64) bool {
	return qq == fengshengConfig.GetInt64("qq.super_admin_qq") || slices.Contains(permData.GetIntSlice("admin"), int(qq))
}
