...
require (
	github.com/CuteReimu/bilibili/v2 v2.0.0-20240602153254-b80c5554c5d4
	github.com/CuteReimu/onebot v0.0.0-20240602153543-8dbfa4f541e1
	...
	github.com/vicanso/go-charts/v2 v2.6.8
